...
All developer and user guides must reside in the root [docs/](file:///home/joel/progetti/TranscribeAPP/docs/) folder. Avoid creating scattered documentation in other subdirectories.

The root documentation index is [docs/README.md](file:///home/joel/progetti/TranscribeAPP/docs/README.md).
...
- **Clickable Links:** Always use absolute `file:///` links to refer to files in the repository.
  - Correct: `[deepLClient.ts](file:///home/joel/progetti/TranscribeAPP/src/services/deepl/deepLClient.ts)`
